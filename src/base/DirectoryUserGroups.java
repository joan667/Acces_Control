...
public final class DirectoryUserGroups {
  ...
  public static void makeUserGroups() {
    ...
    // - Users without any privilege, just to keep temporally users instead of deleting them, this
    // is to withdraw all permissions but still to keep user data to give back permissions later.
    ...
    // - Some areas: "ground floor", "floor 1", "exterior", "stairs" (this, for all), that is,
    //   everywhere but the parking
